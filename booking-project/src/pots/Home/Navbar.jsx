  ...
  return (
    ...
    */}
       ...
       <div className='text-white text-center left-7 absolute  top-1/2 '>
        <h1 className='text-4xl font-bold '>Book affordable rooms with <span className='hover:text-blue-500'>OPION</span> </h1>
        <p className='text-xl '>Find the best rooms at the best prices with our help.</p>
        <button className='m-2 bg-blue-500 rounded-lg px-10 py-2 hover:bg-blue-600'>Find a room</button>
    </div>
